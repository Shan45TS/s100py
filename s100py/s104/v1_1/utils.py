...
def add_metadata(metadata: dict, data_file) -> S104File:
    ...
    water_level_height_uncertainty = (
        water_level_feature_instance_01.uncertainty_dataset.append_new_item()
    )
    ...
    water_level_feature.horizontal_position_uncertainty = metadata[
    ...
    water_level_feature_instance_01.date_time_of_first_record = metadata[
...
def add_data_from_arrays(
    ...
    if data_coding_format == 2:
        ...
        water_level_feature_instance_01.grid_spacing_longitudinal = grid_properties[
            "cellsize_x"
        ]
        water_level_feature_instance_01.grid_spacing_latitudinal = grid_properties[
            "cellsize_y"
        ]
        ...
        water_level_feature.data_coding_format = data_coding_format
        water_level_feature_instance_01.number_of_nodes = grid_properties["nodes"]
        water_level_feature_instance_01.number_of_triangles = grid_properties[
            "num_triangles"
        ]
    ...
    if (
        min_height < water_level_feature.min_dataset_height
        and min_height != FILLVALUE_HEIGHT
    ):
        water_level_feature.min_dataset_height = min_height

    if (
        max_height > water_level_feature.max_dataset_height
        and max_height != FILLVALUE_HEIGHT
    ):
    ...
    water_level_group_object = (
        water_level_feature_instance_01.water_level_group.append_new_item()
    )
...
def update_metadata(data_file, grid_properties: dict, update_meta: dict) -> S104File:
    ...
    water_level_feature_instance_01.date_time_of_last_record = update_meta[
    ...
    water_level_feature_instance_01.time_record_interval = update_meta[
        "timeRecordInterval"
    ]
